/***************************************************
* Starter file given to us by our professor.
* It runs the experiments done on the plant tree 
* and plants. It outputs the results to the console
* that should match the instructors expected results.
****************************************************/
